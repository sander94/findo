...
{
    protected $fillable = ['title', 'description', 'image', 'slider_image', 'video', 'additional_info', 'date', 'time', 'location', 'ticket_price', 'google_address', 'organizator', 'is_promoted', 'is_active', 'tags', 'region'];
